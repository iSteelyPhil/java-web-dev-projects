...
public class Case {
    ...
    public Case(){
        ...
        toppings.add(new Topping("Sprinkles", 0.5, new ArrayList<>()));
        toppings.add(new Topping("Cherries", 0.7, new ArrayList<>()));
        toppings.add(new Topping("Chocolate Chips", 1.0, new ArrayList<>()));
    }
